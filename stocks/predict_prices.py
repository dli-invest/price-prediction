...
def make_predictions(stock):
    ...
    plt.savefig(f'images/prophet/' + stock + '-scaled.png', bbox_inches='tight')
    fig = plt.figure()
...
#    ax1.xaxis_date()
    ...
    plt.savefig(f'images/prophet/' + stock + '-plain.png', bbox_inches='tight')
    ...
    plt.savefig(f'images/prophet/' + stock + '-forecast.png', bbox_inches='tight')
    plt.close(fig='all')
